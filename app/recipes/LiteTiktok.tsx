    ...
    <div className="w-full max-w-[325px] mx-auto rounded-lg overflow-hidden bg-[#b4b4b4] relative">
      {!loadVideo ? (
        <div 
          ...
          className="cursor-pointer w-full aspect-[9/16] bg-cover bg-center flex items-center justify-center"
          style={{ backgroundImage: `url(${thumbnailUrl})` }} // Dynamic background is usually okay
        >
